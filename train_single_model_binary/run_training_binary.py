...
from save_load.io_funcs import save_model, save_mat, save_cfg
...
def run_training_binary(Xs, ys, cfg):
    ...
    print(get_patient_id_by_label(y_true, y_pred, true_label_id=0, predicted_label_id=1, cfg=cfg))
...
if __name__ == '__main__':
    ...
    cfg = run_training_binary(Xs, ys, cfg)
